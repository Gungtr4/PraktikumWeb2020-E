    ...
    <tr>
   	...
   	<tr>
    	<td colspan="2"><input type="submit" name="submit" value="Save" />
        	<a href="index_a.php"><input style="color: black" type="button" value="Cancel" /></a></td>
    </tr>
<?php
	if(isset($_POST['submit'])){
		...
		$sql	     ='insert into mahasiswa(nim,nama,alamat,up_by)value ("'.$nim.'","'.$nama.'","'.$alamat.'","'.$_SESSION['admin'].'")';
