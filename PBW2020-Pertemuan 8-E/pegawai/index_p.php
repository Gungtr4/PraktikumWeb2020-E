				...
				<ul class="nav navbar-top-links navbar-right">
					<li class="dropdown"><a class="dropdown-toggle count-info" data-toggle="dropdown" href="#">
						...
						<ul class="dropdown-menu dropdown-alerts">
							<li><a href="">
								<div><em></em><?php echo($_SESSION['pegawai'])?>
								</div>
							</a></li>
							<li class="divider"></li>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		<div class="profile-sidebar">
			...
			<div class="profile-usertitle">
				<div class="profile-usertitle-name"><?php echo($_SESSION['pegawai'])?></div>
		...
		<ul class="nav menu">
			<li class="active"><a href="index_p.php?form=tambah"><em class="fa fa-dashboard">&nbsp;</em> Tambah Data</a></li>
		...
		while($d=mysqli_fetch_array($b))
		{
			...
			echo'
				<tr align="center">
					...
					<td>'.$alamat.'</td>
					<td>'.$up.'</td>
					<td><a href="index_p.php?page=produk&form=edit&kode='.$id.'">EDIT</td>				
				</tr>';
		}
	}
?>
